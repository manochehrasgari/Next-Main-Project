              ...
              <div className="flex flex-col mr-4 justify-between">
                <div className="flex">
                  ...
                  <Link href={`/blogs/${post.category.englishTitle}`}>
                    <div className="bg-white border border-blue-500 text-xs text-blue-500 px-3 py-1 mr-2 rounded-full transition-all duration-300 hover:bg-blue-500 hover:text-white  ">
                      {post.category.title}
                    </div>
                  </Link>
                </div>
                ...
                <div className="font-normal text-myGray-400 text-sm ">
                  <span>{persianDate(post.createdAt)}</span>
...
`}</pre>
          ...
          <section>
            ...
            <div className="flex items-center flex-col gap-y-8 md:flex-row md:justify-between">
              ...
              />
              {/* share btns */}
              <div className="flex items-center gap-x-6 justify-evenly w-full md:w-auto">
                <div className="flex justify-evenly items-center w-full md:gap-x-4 gap-x-6 md:w-auto">
                  <a
          ...
          <section className="mb-20">
            <h2 className="font-bold text-2xl mb-8">پست های مشابه</h2>
            <div className="grid grid-cols-6 gap-8">
              <PostList blogs={post.related} />
            </div>
          </section>
          {/* post comment */}
